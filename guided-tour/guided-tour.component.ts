      ...
      >
        ...
        <div class="tour-block">
          <div
            *ngIf="
              progressIndicatorLocation ===
                progressIndicatorLocations.TopOfTourBlock &&
          ...
          <div class="tour-buttons">
            ...
            >
              ...
              <ng-container
                *ngIf="
                  progressIndicatorLocation ===
                  progressIndicatorLocations.InsideNextButton
                "
              >
                <ng-container *ngTemplateOutlet="progress"></ng-container>
              </ng-container>
...
export class GuidedTourComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() public progressIndicatorLocation?: ProgressIndicatorLocation =
    ProgressIndicatorLocation.InsideNextButton;
  ...
  private get widthAdjustmentForScreenBound(): number {
    ...
    if (
      ...
      this.windowRef.nativeWindow.innerWidth - this.tourStepWidth
    ) {
      adjustment =
        this.calculatedLeftPosition -
        (this.windowRef.nativeWindow.innerWidth - this.tourStepWidth);
  ...
  private get calculatedLeftPosition(): number {
    ...
    if (this.currentTourStep.orientation === Orientation.Left) {
      return (
        this.selectedElementRect.left - this.tourStepWidth - paddingAdjustment
      );
    }
  ...
  private getStepScreenAdjustment(): number {
    ...
    if (
      this.windowRef.nativeWindow.innerHeight - this.topOfPageAdjustment <
      elementHeight
    ) {
      return (
        elementHeight -
